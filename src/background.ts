...
const SUPABASE_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhkaGJienlsdWF4d2pvc3VyZ2doIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjkxMTc0NDIsImV4cCI6MjA0NDY5MzQ0Mn0.07yOFnNTVTxJWCqCZcPhA8ohMG3E9gtvhCuPFC2Pdmg";
  ...
  const requestBody = {
    ...
    properties: {
      ...
      company: jobDetails.company
        ...
        : undefined,
      pay_per_hour:
        jobDetails.pay_per_hour !== undefined
          ? {
...
// - type: string
// - deadline: Date
async function addJobDetailsToSupabase(data: JobApplicationDetails) {
